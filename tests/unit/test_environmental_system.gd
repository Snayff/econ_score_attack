...
const EnvironmentalSystem = preload("../../scripts/core/environmental_system.gd")
const DataLandParcel = preload("../../scripts/data/data_land_parcel.gd")
const DataEnvironmentalEffect = preload("../../scripts/data/data_environmental_effect.gd")
